...
public class OrderService {
    ...
    // Annotate service methods that perform multiple DB operations with @Transactional
    @Transactional
...
| Pattern matching `switch` (exhaustive) | Java 21 |
| Virtual threads | Java 21 |

If your project targets an older LTS (e.g., Java 11/17), avoid features from later versions.
